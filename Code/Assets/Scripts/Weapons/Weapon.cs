...
public abstract class Weapon : Item
{
    ...
    protected virtual void Update()
    {
        ...
        {
            Attack(currentStats.number + player.Stats.amount);        
        }
    }
    ...
    public override bool DoLevelUp()
    {
        ...
        if(!CanLevelUp())
        {
            Debug.LogWarning("Cannot level up, max level reached.");
            return false;
        }
    ...
    {
        return currentStats.GetDamage() * player.Stats.damageMultiplier;
    }
