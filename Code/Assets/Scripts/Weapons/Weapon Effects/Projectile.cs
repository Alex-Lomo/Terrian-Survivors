...
public class Projectile : WeaponEffect
{
    ...
    protected virtual void Start()
    {
        ...
        if (hasAutoAim) AquireAutoAimFacing();
    }

    public virtual void AquireAutoAimFacing()
    {
        float aimAngle;
    ...
    protected virtual void FixedUpdate()
    {
        ...
        {
            Weapon.Stats stats = weapon.GetStats();
            transform.position += transform.right * stats.speed* weapon.Owner.Stats.projectileSpeed * Time.fixedDeltaTime;
